...
function createDefaultContainerInfo() {
    return {
...
function detectContainerEnvironment(options = {}) {
    ...
    const info = createDefaultContainerInfo();
    ...
    try {
        ...
        // Ignore probe errors and fall back to host metrics.
    }
...
function readContainerMemoryUsage() {
    try {
        ...
        // Ignore probe errors and let callers fall back to host metrics.
    }
